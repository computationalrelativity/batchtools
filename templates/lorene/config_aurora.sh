...
INC = -I\$(HOME_LORENE)/C++/Include \
          -I\$(HOME_LORENE)/C++/Include_extra -I\$(HOME)/gsl/include 
...
# ---------------------------------------
LIB_LAPACK = -L${MKLROOT}/lib -lmkl_intel_lp64 -lmkl_sequential -lmkl_core -lpthread -lm
...
# -----------------------------------
LIB_GSL = $(gsl-config --libs) -L/opt/aurora/25.190.0/oneapi/compiler/2025.2/lib -lsvml -limf -lirng -lintlc
EOF
